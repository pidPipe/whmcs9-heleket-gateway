...
final class Payment
{
     ...
     *
     * Must be signed with the PAYOUT api key, not the payment key.
     *
     * @param array $data address, is_subtract, uuid|order_id, [amount]
     * @return bool|mixed
     * @throws RequestBuilderException
     */
    public function refund(array $data)
    {
        return $this->requestBuilder->sendRequest($this->version . '/payment/refund', $data);
    }
}
